...
class PersonaController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json($persona->load('sexo'));
    }

    public function show(int $id): JsonResponse
    {
        $persona = Persona::with('sexo')->findOrFail($id);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $persona->update([
            ...
            'id_sexo' => $request->id_sexo ?? $persona->id_sexo,
            'celular' => $request->celular ?? $persona->celular,
            'correo_personal' => $request->correo_personal ?? $persona->correo_personal,
        ]);

        return response()->json($persona->fresh('sexo'));
    }
